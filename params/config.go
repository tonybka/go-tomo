...
var (
	...
	AllTomoProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, &TomoConfig{Period: 0, Epoch: 30000}}
...
type ChainConfig struct {
	...
	Tomo   *TomoConfig   `json:"tomo,omitempty"`
}
...
func (t *TomoConfig) String() string {
	return "tomo"
}
